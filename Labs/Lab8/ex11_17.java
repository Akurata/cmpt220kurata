...
public class ex11_17 {
	...
	public static void main(String[] args) {
			...
			System.out.println("The smallest n for m * n to be a perfect square is: " + smallestSquare);
	    ...
	    private static int smallestSquare(ArrayList<Integer> factors) {
			...
			ArrayList<Integer> oddSequenceFactors = removeMultiple(occurrences);
	    ...
	    private static ArrayList<Integer> removeMultiple(int[][] m) {
